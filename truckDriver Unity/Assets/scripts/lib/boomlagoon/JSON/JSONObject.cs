				...
				switch (state) {
					...
					case JSONParsingState.EndObject:
						...
						switch (currentValue.Parent.Type) {
							...
							case JSONValueType.Object:
								currentValue.Parent.Obj.values[keyStack.Pop()] = new JSONValue(currentValue.Obj);
								break;
					...
					case JSONParsingState.String:
						...
						switch (currentValue.Type) {
							...
							case JSONValueType.Object:
								currentValue.Obj.values[keyStack.Pop()] = new JSONValue(str);
								break;
					...
					case JSONParsingState.Number:
						...
						switch (currentValue.Type) {
							...
							case JSONValueType.Object:
								currentValue.Obj.values[keyStack.Pop()] = new JSONValue(number);
								break;
					...
					case JSONParsingState.Boolean:
						if (jsonString[startPosition] == 't') {
							...
							switch (currentValue.Type) {
								...
								case JSONValueType.Object:
									currentValue.Obj.values[keyStack.Pop()] = new JSONValue(true);
									break;
							...
							switch (currentValue.Type) {
								...
								case JSONValueType.Object:
									currentValue.Obj.values[keyStack.Pop()] = new JSONValue(false);
									break;
					...
					case JSONParsingState.EndArray:
						...
						switch (currentValue.Parent.Type) {
							...
							case JSONValueType.Object:
								currentValue.Parent.Obj.values[keyStack.Pop()] = new JSONValue(currentValue.Array);
								break;
					...
					case JSONParsingState.Null:
						if (jsonString[startPosition] == 'n') {
							...
							switch (currentValue.Type) {
								...
								case JSONValueType.Object:
									currentValue.Obj.values[keyStack.Pop()] = new JSONValue(JSONValueType.Null);
									break;
